# Readme to run the script and create a summarized tidy data set for each subject/activity
...
This will generate the tidy.txt file by going through the following steps
--------------------
